# Dual-Domain Fusion Network D2FNet for Enhanced Bearing Fault Diagnosis: Integrating Time and Time-Frequency Features via Input Feature Mappings and Vision Transformer
