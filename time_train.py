...
def train():
        ...
        for epoch in range(num_epoch):
            ...
            with torch.no_grad():
                ...
                if epoch_val_acc / len(val_fold) >= best_val_acc:
                    ...
                    torch.save(net.state_dict(), './models_save/pu_time_'+str(k)+'.pth')
    ...
    plt.savefig('./results/pu_time_Acc.png')
    plt.show()
    ...
    plt.title('model_supervised')
    plt.savefig('./results/pu_time_loss.png')
    plt.show()
    ...
    plt.savefig('./results/pu_time_PR.png')
    plt.show()
    # 绘制ROC曲线
    fpr = dict()
    tpr = dict()
    ...
    plt.savefig("./results/pu_time_ROC.png")
    plt.show()
...
if __name__ == '__main__':
    ...
    train_dataset = time_dataset(data=data_train, label=label_train)
